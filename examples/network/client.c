...
int main()
{
    // Configures Socket To Use Port 9020, IPv6 (1-1-4-1);
    unsigned int s=socket(10,2050,17),q[7],t[7],l=28,y;*q=9020<<16|10;*t=9010<<16|10;bind(s,(struct sockaddr*)&q,l);ck(h,j,10);

    // Send Newly Encrypted Message Back;
    unsigned char b[16]="Hello, Client 0!",*z=g;i=b;w=b+16;do{*z=*i;z+=1;i+=1;}while(i<w);cc(j,g,g+16);sendto(s,&g,16,0,(struct sockaddr*)&t,l);
